...
<body>
    ...
    <form method="post">
        <label>
            <input type="radio" name="color_scheme" value="light" <?php echo $color_scheme == 'light' ? 'checked' : ''; ?>>
        Light
        </label>
        <br>
        <label>
            <input type="radio" name="color_scheme" value="dark" <?php echo $color_scheme == 'dark' ? 'checked' : ''; ?>>
        Dark
        </label>
        <br>
